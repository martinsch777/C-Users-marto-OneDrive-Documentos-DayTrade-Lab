...
| HYP-FCR-01 | First Candle Rule: OR 30m + FVG reentry | 2026-07-21 | Registered only; not run | Blocked until discovery passes every gate | 2026 observed_contaminated_non_decisional | 0 trades run | Preregistered only; no performance metrics generated | Preregistered not run | Not applicable | `configs/research/hypotheses/HYP-FCR-01.yaml`; `docs/HYP_FIRST_CANDLE_PREREGISTRATION.md`; `docs/FIRST_CANDLE_TRADINGVIEW_PARITY_SPEC.md`; `docs/HYP_FIRST_CANDLE_TEST_TRACEABILITY.md`; `src/research/hyp_first_candle.py` | First discovery run must use frozen parameters; 2026 may only be used later for parity debugging |
